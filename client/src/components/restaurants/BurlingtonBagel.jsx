...
import BurlingtonBagelMap from "../restaurantMaps/BurlingtonBagelMap";

// useState and restaurant info declarations
let restInfo;
function BurlingtonBagel(props) {
  ...
  useEffect(() => {
    fetch("/api/burlington-bagel-bakery")
      .then((res) => res.json())
...
export default BurlingtonBagel;
